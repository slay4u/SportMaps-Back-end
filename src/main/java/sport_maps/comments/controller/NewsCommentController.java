...
@RestController
@RequestMapping(BASE_URL + "/news-comments")
public class NewsCommentController {
    @Qualifier("newsCommentServiceImpl")
    private final CommentService service;

    public NewsCommentController(@Qualifier("newsCommentServiceImpl") CommentService service) {
