...
@Transactional
public class ForumCommentServiceImpl extends AbstractService<ForumComment, ForumCommentDao, Mapper> implements CommentService {
    ...
    public ForumCommentServiceImpl(UserDao userDao, ForumDao forumDao) {
