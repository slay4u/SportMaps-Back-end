...
class NewsCommentControllerTest {
    ...
    @Autowired
    private NewsCommentDao eventCommentDao;
    ...
    void create() throws Exception {
        ...
        MockHttpServletRequestBuilder mockRequest = post("/sm/news-comments")
        ...
        NewsComment goods = eventCommentDao.findById(1L).orElseThrow();
    ...
    void update() throws Exception {
        ...
        MockHttpServletRequestBuilder mockRequest = put("/sm/news-comments/{id}", 1)
                .header("Authorization", "Bearer " + jwt)
                .contentType(MediaType.APPLICATION_JSON)
                .content(mapper.writeValueAsString(commentSaveDto));
    ...
    void delete_success() throws Exception {
        MockHttpServletRequestBuilder mockRequest = delete("/sm/news-comments/{id}", 1)
                .header("Authorization", "Bearer " + jwt)
                .contentType(MediaType.APPLICATION_JSON);
